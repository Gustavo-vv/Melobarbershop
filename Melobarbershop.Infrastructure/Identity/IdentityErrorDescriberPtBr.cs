...
namespace Melobarbershop.Infrastructure.Identity;
...
public class IdentityErrorDescriberPtBr : IdentityErrorDescriber
{
    ...
    public override IdentityError InvalidUserName(string? userName)
    {
        return new IdentityError
        {
            ...
            Description = $"O nome de usuário '{userName}' é inválido. Ele pode conter apenas letras ou dígitos."
        };
    }
    ...
    public override IdentityError DuplicateRoleName(string role)
    {
        return new IdentityError
        {
            ...
            Description = $"O perfil '{role}' já está em uso."
        };
    }
    ...
    public override IdentityError PasswordRequiresNonAlphanumeric()
    {
        return new IdentityError
        {
            ...
            Description = "A senha deve conter ao menos um caractere especial (não alfanumérico)."
        };
    }
    ...
    public override IdentityError PasswordRequiresDigit()
    {
        return new IdentityError
        {
            ...
            Description = "A senha deve conter ao menos um dígito numérico ('0'-'9')."
        };
    }
    ...
    public override IdentityError PasswordRequiresUniqueChars(int uniqueChars)
    {
        return new IdentityError
        {
            ...
            Description = $"A senha deve conter ao menos {uniqueChars} caracteres distintos."
        };
    }
