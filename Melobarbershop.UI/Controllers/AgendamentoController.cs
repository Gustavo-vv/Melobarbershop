// ============================================================================
// Arquivo: AgendamentoController.cs
// Camada: Melobarbershop.UI (Controllers)
// Objetivo: Controlador do fluxo de agendamento online de clientes no portal Web.
// Papel na Arquitetura:
//   - Carrega serviços ativos e barbeiros disponíveis via chamadas HTTP à API interna.
//   - Expõe endpoints AJAX para atualização dinâmica de horários disponíveis baseados na data e profissional.
//   - Valida a autenticação do cliente extraindo a identidade do JWT e cria o agendamento no sistema.
// ============================================================================
...
/// <summary>
/// Controlador responsável pelas etapas e requisições do fluxo de agendamento online.
/// </summary>
public class AgendamentoController : Controller
{
    ...
    /// <summary>
    /// Construtor com injeção do HttpClientFactory e Logger.
    /// </summary>
    ...
    /// <summary>
    /// Renderiza a tela principal de agendamento carregando os catálogos iniciais de serviços, barbeiros e horários.
    /// </summary>
    [HttpGet]
    ...
    /// <summary>
    /// Retorna os horários disponíveis para um barbeiro/dia/serviço(s), consumido via AJAX pela interface.
    /// </summary>
    [HttpGet]
    ...
    /// <summary>
    /// Cria o agendamento no banco via POST /api/Agendamentos com a identidade do cliente autenticado via JWT.
    /// </summary>
    [HttpPost]
    public async Task<IActionResult> Criar([FromBody] CriarAgendamentoRequisicao requisicao)
    {
        ...
        // Extrai a claim jwt_token do usuário autenticado
    ...
    /// <summary>
    /// Chama GET /api/Agendamentos/horarios-do-dia e converte o resultado para HorarioDisponivelViewModel.
    /// </summary>
...
/// <summary>
/// Modelo de requisição recebido via AJAX para criação de agendamento na UI.
/// </summary>
public class CriarAgendamentoRequisicao
{
    /// <summary>Identificador do barbeiro escolhido.</summary>
    public string BarbeiroId { get; set; } = string.Empty;

    /// <summary>Data e hora inicial pretendida para o atendimento.</summary>
    public DateTime DataHoraInicio { get; set; }

    /// <summary>Lista de identificadores dos serviços que compõem o agendamento.</summary>
    public List<int> ServicoIds { get; set; } = new();

    /// <summary>Observações ou preferências adicionais informadas pelo cliente.</summary>
