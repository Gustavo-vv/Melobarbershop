// ============================================================================
// Arquivo: UcDashboard.cs
// Camada: Melobarbershop.Desktop (Forms / Dashboard)
// Objetivo: Controle de usuário exibindo indicadores consolidados, fila do dia e resumo rápido.
// Papel na Arquitetura:
//   - Faz chamadas paralelas via Task.WhenAll para serviços, usuários e agendamentos de hoje.
//   - Renderiza cards de métricas (Serviços Ativos, Barbeiros, Clientes e Fila de Atendimento).
//   - Oferece ações diretas de Check-in, Conclusão e Confirmação de agendamentos no fluxo de fila.
// ============================================================================
...
/// <summary>
/// Painel de controle do Dashboard exibindo métricas gerais e a fila dinâmica de agendamentos do dia.
/// </summary>
public partial class UcDashboard : UserControl
{
    ...
    /// <summary>
    /// Construtor padrão do UserControl de Dashboard.
    /// </summary>
    public UcDashboard()
    {
        InitializeComponent();
    ...
    /// <summary>
    /// Configura as fontes de cabeçalho e aplica o tema inicial.
    /// </summary>
    ...
    /// <summary>
    /// Atualiza cores de fundo, cards de estatísticas, listas e grid conforme o tema ativo.
    /// </summary>
    ...
    /// <summary>
    /// Aplica tipografia e paleta de cores específicas a um card métrico individual.
    /// </summary>
    ...
    /// <summary>
    /// Consulta assincronamente a API em paralelo para atualizar indicadores, fila do dia e resumo.
    /// </summary>
    ...
    /// <summary>
    /// Reconstrói os cartões da fila de agendamentos dentro do painel rolável.
    /// </summary>
    ...
    /// <summary>
    /// Constrói a representação visual (Panel) de uma comanda/agendamento com detalhes e botões de ação rápida.
    /// </summary>
    private Panel CriarCardAgendamentoLinha(AgendamentoDto ag)
    {
        ...
        // 2. Tag de Origem (SITE ou BALCÃO)
    ...
    /// <summary>
    /// Cria um botão de ação com cantos arredondados e posicionamento relativo à direita.
    /// </summary>
